...
public class testosteroneModBlocks {
    ...
    public static final RegistryObject<Block> TESTOSTERONE_PILL_BLOCK = registerBlock("testosterone_pill_box", () -> new testosterone_pill_box(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).sound(EstrogenSoundTypes.PILL_BOX)));
