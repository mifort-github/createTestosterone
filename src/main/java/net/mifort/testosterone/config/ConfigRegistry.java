...
public class ConfigRegistry {
	...
	public static void register() {
		ForgeConfigRegistry.INSTANCE.register(testosterone.MOD_ID, ModConfig.Type.CLIENT, CLIENT_SPEC);
		ForgeConfigRegistry.INSTANCE.register(testosterone.MOD_ID, ModConfig.Type.SERVER, SERVER_SPEC);
	}
}
